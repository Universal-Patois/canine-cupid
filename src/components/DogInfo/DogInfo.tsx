  ...
  return (
    <section className="dog-info-container">
      ...
      <div className="height">
        <h3>Height:</h3>
        <h4 className="height-imperial">Imperial: {selectedDog?.height.imperial} inches</h4>
        <h4 className="height-metric">Metric: {selectedDog?.height.metric} cm</h4>
      </div>
      <div className="weight">
        <h3>Weight:</h3>
        <h4 className="weight-imperial">Imperial: {selectedDog?.weight.imperial} lbs</h4>
        <h4 className="weight-metric">Metric: {selectedDog?.weight.metric} kg</h4>
      </div>
